...
```{r}
la_shp = read_sf('https://bit.ly/3p6ibF1')
```
...
msoa_shp = read_sf('https://opendata.arcgis.com/datasets/5d4e4cc075ef4a40acbe6e50735451ef_0.geojson') %>%
  st_transform(29902)
...
g = GET('http://sedsh127.sedsh.gov.uk/Atom_data/ScotGov/ZippedShapefiles/SG_DataZoneBdry_2011.zip', write_disk(tempf))
